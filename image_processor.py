...
# def process_and_classify_images(feature_map_model, test_directory,base_output_path):
   
#     class_name = os.path.basename(test_directory)
...
#     eval_csv_path = os.path.join(eval_dir, f'evaluation_set.csv')
#     verif_csv_path = os.path.join(verif_dir, f'verification_set.csv')
